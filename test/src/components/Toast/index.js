...
test('__Toast Component__', t => {
  t.test('handles initial show prop on mount', t => {
    t.plan(2);
    const wrapper = mount(<Toast {...defaultProps} show={true}>{'hi'}</Toast>);
